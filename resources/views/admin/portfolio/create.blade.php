...
<div class="app-title">
    <div>
        <h1><i class="fa fa-briefcase"></i> &nbsp; Add New Portfolio</h1>
    </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input name="name" class="form-control @error('name') is-invalid @enderror" id="name" type="text"  placeholder="portfolio Name" value="{{ old('name') }}">
                        @error('name')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input name="url" class="form-control @error('url') is-invalid @enderror" id="fb" type="text"  placeholder="Portfolio url" value="{{ old('url') }}">
                        @error('url')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
