...
<div class="app-title">
    <div>
        <h1><i class="fa fa-briefcase"></i> &nbsp; Add New Partner</h1>
    </div>
...
<div class="row">
    <div class="col-md-12">
        <form method="POST" action="{{route('patner.store')}}" enctype="multipart/form-data">
        @csrf
        <div class="tile">
        <div class="row">
            <div class="col-lg-6">
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input name="name" class="form-control @error('name') is-invalid @enderror" id="name" type="text"  placeholder="partner Name" value="{{ old('name') }}">
                        @error('name')
            ...
            <div class="col-lg-6">
                <div class="form-group row">
                    <label class="col-md-3" for="image">Partner Icon <span class="text-danger">*</span></label>
                    <div class="col-md-9">
        ...
        <div class="tile-body">
            ...
            <table class="table table-hover table-bordered text-center" id="sampleTable">
                ...
                <tr>
                    ...
                    <td>
                        <img style="height: 40px; width:40px;" src="{{ asset($item->logo) }}" alt="">
                    </td>
                    <td>
                        <a href="{{ route('patner.edit',$item) }}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>
                        <button type="submit" class="btn btn-danger btn-sm" onclick="deleteServic({{ $item->id }})"><i class="fa fa-trash"></i></button>
                        <form id="delete-form-{{ $item->id }}" action="{{ route('patner.destroy',$item) }}" method="POST" style="display: none;">
                            @csrf
                            @method('DELETE')
                        </form>
                    </td>
