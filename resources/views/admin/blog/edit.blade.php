...
<div class="app-title">
    <div>
        <h1><i class="fa fa-briefcase"></i> &nbsp; Edit Blog Post</h1>
    </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" value="{{ $blog->title }}" placeholder="Enter Blog Title">
                        @error('title')
                ...
                <div class="form-group row mt-2">
                    ...
                    <div class="col-md-9">
                        <input name="date" class="form-control @error('date') is-invalid @enderror" id="date" type="date" value="{{  $blog->date }}">
                        @error('date')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
